...
{
    public class ExtendHierarchyTag : ITagObject
    {
        public HtmlTag RootTag { get; set; } = new HtmlTag();
        public Dictionary<int, HierarchyTag> ContentTags { get; set; } = new Dictionary<int, HierarchyTag>();

        public ConcurrentDictionary<string, string> Attributes { get; set; } = new ConcurrentDictionary<string, string>();


        public ExtendHierarchyTag()
        {
        }

        public ExtendHierarchyTag(string _name)
        {
